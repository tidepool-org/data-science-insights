...
Phase B implementation will:
    ...
    2. Sequentially call .run(spark, ...) on each data_staging module in
       dependency order:
            ...
            export_user_day_age
            export_user_day_master
    3. Return the master table name for the end-to-end test to read from.
...
def run(spark, bddp_table: str, output_prefix: str) -> str:
    ...
    Returns the fully-qualified name of the `user_day_master` table.
    """
