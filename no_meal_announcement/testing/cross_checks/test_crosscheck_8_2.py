...
def test_table_8_2a_nma_autobolus_tir():
    ...
    df = pd.read_csv(SNAPSHOT, usecols=["_userId", "day_eligible", "user_eligible", "age_years", "in_ce0_be_inf", "delivery_strategy", "tir"])
...
def test_table_8_2b_interaction_tir():
    ...
    df = pd.read_csv(SNAPSHOT, usecols=["_userId", "day_eligible", "user_eligible", "age_years", "in_ce0_be_inf", "in_ce_gt0", "delivery_strategy", "tir"])
