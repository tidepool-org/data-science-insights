...
- **Status:** implemented (§8.1, all cohorts); staged column regenerated and the analysis-side derive bridge removed. Finding: high-engagement days modestly worse than typical CE>0 (TIR −0.9 LMM / −1.1 windowed); NMA days run ~+1.6 TIR above high-engagement days (fig 8.1c).
