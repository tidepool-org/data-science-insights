...
- [x] Flesh out the **§8.2/§8.3/§8.4 runnable integration checks** (`run_test_analysis_8_{2,3,4}.py`) — **done 2026-06-07** (see the implemented entry above; pending a Databricks run to execute).
