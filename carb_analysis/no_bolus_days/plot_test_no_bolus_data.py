"""
Plot the raw test data from dev.fda.test_no_bolus_device_data.

Simple query → time-series plots showing CBG values, loop recommendation type,
and bolus events across all 30 days, so you can visually verify the test data
before running the production SQL against it.
"""
...
day_ranges = [
    ("2024-01-01", "2024-01-10", "TB + No Bolus", "#4A90D9"),
    ("2024-01-11", "2024-01-20", "AB + No Bolus", "#D94A4A"),
    ("2024-01-21", "2024-01-25", "TB + Bolus", "#4A90D9"),
    ("2024-01-26", "2024-01-30", "AB + Bolus", "#D94A4A"),
]
