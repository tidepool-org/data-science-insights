...
-- (389 transition users / 44 w-any-AB-preset / paired N 37) are now stale and
-- must be REGENERATED by re-running this query on Databricks — the gated
-- denominator is smaller (~351 at the transition level for the box080 build).
-- =============================================================================
...
-- 2) Cohort denominator and paired N (type-1-gated; re-run for current values) -
SELECT
